...
class TransformerTestCase(TestCase):
    ...
    def test_member_transformer(self):
        ...
        data = ['1000AA', '2015-01-01T00:00:00.000Z', 'Paleis Dam 1', '', 'Henk', '', 'Wijngaarden', 'Netherlands', '',
                '', '2015-01-01T00:00:00.000Z', '', '', 'Vlammetje', '2015-01-01T00:00:00.000Z', '',
                'henk@vlamindepijp.nl', '0', '1', None, '', 'Male', None, None, '', None, '', 'Nul Twintig', '', '0',
                '1', None]
